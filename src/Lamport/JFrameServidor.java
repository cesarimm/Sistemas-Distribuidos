...
/**
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(31, 31, 31)
                                .addComponent(jTextFieldProceso, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int c = Integer.parseInt(this.jTextFieldProceso.getText());
        JFrameProceso jf = new JFrameProceso(c);
        jf.setVisible(true);
        this.listaProceso.add(jf);
        this.numProcesos.setText(Integer.toString(this.listaProceso.size()));
       // String aux="";
        
        for(int i=0;i<this.listaProceso.size();i++){ 
            listaProceso.get(i).setListaProceso(listaProceso);
           // aux+=listaProceso.get(i).getContador()+" ";   
        }
        
      //  this.jInfo.setText(aux);     
